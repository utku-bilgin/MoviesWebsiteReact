    ...
    useEffect(() => {
        fetch(`https://localhost:7131/api/Movie/${id}`)
            ...
            .then(data => {
                ...
                setMoviePosterUrl(data.moviePosterUrl);
                setDirector(data.director);
                setCast(data.cast);
                setProductionYear(data.productionYear);
                setMovieDuration(data.movieDuration);
                setCountry(data.country);
                setImdbRating(data.imdbRating);
                setMovieTrailerUrl(data.movieTrailerUrl)
                console.log(data)
    ...
    const handleInputChange = (e) => {
        ...
        switch (name) {
            ...
            case "categoryName":
                ...
                break;
            case "movieTrailerUrl":
                setMovieTrailerUrl(value);
                break;
            default:
                break;
        }
